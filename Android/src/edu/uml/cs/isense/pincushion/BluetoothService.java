...
public class BluetoothService {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(Sensors.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(Sensors.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(Sensors.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(Sensors.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(Sensors.TOAST, "Unable to connect device");
        msg.setData(bundle);
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(Sensors.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(Sensors.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
