...
public class BluetoothService {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(PINCushion.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(PINCushion.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(PINCushion.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(PINCushion.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(PINCushion.TOAST, "Unable to connect device");
        msg.setData(bundle);
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(PINCushion.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(PINCushion.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
